...
from db.queries.assessment_records.queries import find_assessor_task_list_state, update_status
...
def update_ar_status(application_id: str, status: str):
    """ Function updates the status for the given application_id"""
