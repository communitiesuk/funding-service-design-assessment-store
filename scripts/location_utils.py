...
def location_not_found(error: bool= True):
    """A function that returns a dictionary with default values indicating that a location was not found.
    Params:
    error (bool): A boolean value of False means the location was found, while a value of True means the location was not found. """
