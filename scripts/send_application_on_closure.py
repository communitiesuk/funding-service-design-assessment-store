...
import services.apply  # noqa: E402
from app import app  # noqa: E402
from config import Config  # noqa: E402
from db.queries.apply import search_applications  # noqa: E402
from db.queries.apply import get_forms_by_app_id  # noqa: E402
from db.queries.apply.application import create_qa_base64file  # noqa: E402
from services.apply.models.notification import Notification  # noqa: E402
from services.apply.data import get_fund  # noqa: E402
...
def send_incomplete_applications_after_deadline(
    ...
    """Retrieves a list of unsubmitted applications and associated form and user
    data for each. Then, it uses the notification service to email the account ID
    ...
    if datetime.now() > deadline:
        ...
        for application in matching_applications:
            ...
            try:
                ...
                try:
                    account_id = services.apply.get_account(account_id=application.get("account_id"))
...
def get_fund_round(fund_id, round_id):
    return services.apply.get_data(
