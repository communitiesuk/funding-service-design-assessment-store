...
To delete a single assessment record:
```
python -m scripts.delete_data delete-assessment-record -id <application_id_to_delete>
```

To delete all assessments in a round:
```
