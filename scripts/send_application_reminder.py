...
from services.apply.exceptions import NotificationError  # noqa: E402
...
def application_deadline_reminder(flask_app):
    with flask_app.app_context():
        ...
        funds = services.apply.get_data(Config.FUND_STORE_API_HOST + Config.FUNDS_ENDPOINT)

        for fund in funds:
            fund_id = fund.get("id")
            round_info = services.apply.get_data(
            ...
            for round in round_info:
                ...
                if not application_reminder_sent and reminder_date < current_datetime < round_deadline:
                    ...
                    fund_info = services.apply.get_data(
                    ...
                    for application in not_submitted_applications:
                        ...
                        account = services.apply.get_account(account_id=application.get("account_id"))
