...
Revision ID: f55f163080d3
Revises: 
Create Date: 2022-11-18 13:04:28.932815
...
def upgrade():
    ...
    sa.Column('langauge', postgresql.ENUM('en', 'cy', name='langauge'), nullable=True),
    ...
    sa.Column('application_json_md5', sa.TEXT(), sa.Computed('md5(CAST(jsonb_blob AS TEXT))', persisted=True), nullable=True),
    ...
    with op.batch_alter_table('assessment_records', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_application_jsonb', ['jsonb_blob'], unique=False, postgresql_ops={'jsonb_blob': 'jsonb_path_ops'}, postgresql_using='gin')
...
def downgrade():
    ...
    with op.batch_alter_table('assessment_records', schema=None) as batch_op:
        ...
        batch_op.drop_index('ix_application_jsonb', postgresql_ops={'jsonb_blob': 'jsonb_path_ops'}, postgresql_using='gin')
