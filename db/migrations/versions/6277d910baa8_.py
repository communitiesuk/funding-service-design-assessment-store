...
def upgrade():
    ...
    op.create_table('qa_complete',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('application_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('user_id', sa.String(), nullable=False),
    sa.Column('date_created', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['application_id'], ['assessment_records.application_id'], name=op.f('fk_qa_complete_application_id_assessment_records')),
