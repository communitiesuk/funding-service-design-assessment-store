...
def upgrade():
    ...
    sa.Column('comment_type', postgresql.ENUM('COMMENT', name='commenttype'), nullable=True),
    sa.Column('theme_index', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['application_id'], ['assessment_records.application_id'], name=op.f('fk_comments_application_id_assessment_records')),
