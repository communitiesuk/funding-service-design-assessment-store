...
from db.queries.apply.application import get_application_status
from db.queries.apply.form import get_forms_by_app_id
from scripts.seed_db_test_data import FUND_CONFIG
from tests_apply.seed_data.seed_db import seed_completed_application
from tests_apply.seed_data.seed_db import seed_in_progress_application
from tests_apply.seed_data.seed_db import seed_not_started_application
from tests_apply.seed_data.seed_db import seed_submitted_application
...
def test_seed_application_submitted(fund_config, round_config, _db, clear_test_data, local_fund_store, mocker):
    mocker.patch("db.queries.apply.application.queries.list_files_by_prefix", return_value=MagicMock())
