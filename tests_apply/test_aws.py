...
def test_list_files_by_prefix_multiple_files(mocker):
    """GIVEN an S3 objects response with multiple files WHEN calling
    list_files_by_prefix with a prefix THEN it should return a list of FileData
    instances with the correct key parts."""
    ...
    mocker.patch(
        "services.apply.aws._S3_CLIENT.list_objects_v2",
