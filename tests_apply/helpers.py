...
def expected_data_within_response(
    ...
    **kwargs,
    ...
    """Given a endpoint and expected content, check to see if response contains
    expected data.
...
def put_response_return_200(test_client, endpoint):
    """Given a endpoint check to see if returns a 200 success response.
...
def put_data(test_client, endpoint: str, data: dict):
    """Given an endpoint and data, check to see if response contains expected
    data.
...
def count_fund_applications(test_client, fund_id: str, expected_application_count):
    ...
    """
    fund_applications_endpoint = f"/apply/applications?fund_id={fund_id}"
...
def post_test_applications(client):
    post_data(client, "/apply/applications", test_application_data[0])
    post_data(client, "/apply/applications", test_application_data[1])
    post_data(client, "/apply/applications", test_application_data[2])
